 ...
 * @author Junior
 */
public class ExibirRecepcionista extends javax.swing.JFrame {

    /**
     * Creates new form ExibirRecepcionista
     */
    public ExibirRecepcionista() {
        initComponents();
    }
    
    public ExibirRecepcionista(String nome, String senha) {
        initComponents();
        ...
        txtSenhaRecepcionista.setEditable(false);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Exibir Recepcionista - ADS Consultas");
        ...
        setSize(new java.awt.Dimension(483, 244));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExibirRecepcionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExibirRecepcionista().setVisible(true);
            }
        });
    }
